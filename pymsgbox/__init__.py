...
def __fillablebox(msg, title="", default="", mask=None, root=None, timeout=None):
    ...
    # ------------------ ok button -------------------------------
    okButton = ttk.Button(buttonsFrame, takefocus=1, text=OK_TEXT)
    _bindArrows(okButton)
    okButton.pack(expand=1, side=tk.LEFT, padx="3m", pady="3m", ipadx="2m", ipady="0m")
    ...
    cancelButton.pack(
        expand=1, side=tk.RIGHT, padx="3m", pady="3m", ipadx="2m", ipady="0m"
    )
